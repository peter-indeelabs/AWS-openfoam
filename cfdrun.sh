...
PATH="/bin:/usr/bin:/sbin:/usr/sbin:/usr/local/bin:/usr/local/sbin:s3://indeenfsworkdir/sim18-run-batch:/opt/openfoam6/platforms/linux64GccDPInt32Opt/bin/"
BASENAME="${0##*/}"
...
export BATCH_FILE_S3_URL="s3://indeenfsworkdir/sim18-run-batch/test.sh"
${BASENAME} test.sh [ <script arguments> ]

  - or -

export BATCH_FILE_TYPE="zip"
export BATCH_FILE_S3_URL="s3://indeenfsworkdir/sim18-run-batch/test.zip"
${BASENAME} test.zip  [ <script arguments> ]
ENDUSAGE
